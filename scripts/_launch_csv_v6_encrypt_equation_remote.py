#!/usr/bin/env python3
"""
v6: continue from v4 adapter + all structural hints:
  numeric auto, cipher auto, encrypt lexical auto, equation shape auto.
"""
...
OUT = "/home/jovyan/work/Nemotron-training/outputs/csv_train_ddp_v6_encrypt_equation_hints"
