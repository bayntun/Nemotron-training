#!/usr/bin/env python3
"""
v7: v4 adapter + all hints including gated text-cipher + 8-bit binary arrow hints.
Cipher hints only fire on encrypt/cipher-labeled prompts; binary hints only on binary family.
"""
...
OUT = "/home/jovyan/work/Nemotron-training/outputs/csv_train_ddp_v7_binary_hint"
