#!/usr/bin/env python3
"""
v11b: v4 adapter + full hints; equation hint = auto_rulescored (numeric top-2 fit line).
"""
...
OUT = "/home/jovyan/work/Nemotron-training/outputs/csv_train_ddp_v11b_eq_rulescore"
