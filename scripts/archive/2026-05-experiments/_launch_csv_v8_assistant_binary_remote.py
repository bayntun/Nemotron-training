#!/usr/bin/env python3
"""
v8: v4 adapter + full hint stack + assistant-only CE loss + binary arrow hints + gated cipher.
"""
...
OUT = "/home/jovyan/work/Nemotron-training/outputs/csv_train_ddp_v8_assistant_binary_hint"
