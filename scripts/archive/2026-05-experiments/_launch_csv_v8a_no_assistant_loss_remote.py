#!/usr/bin/env python3
"""
v8a: v4 adapter + full hint stack + binary arrow hints + gated cipher (no assistant-only loss).
"""
...
OUT = "/home/jovyan/work/Nemotron-training/outputs/csv_train_ddp_v8a_no_assistant_loss"
