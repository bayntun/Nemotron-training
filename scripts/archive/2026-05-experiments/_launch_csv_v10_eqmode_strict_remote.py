#!/usr/bin/env python3
"""
v10: v4 adapter + full hint stack + strict equation-mode trigger/guidance (no assistant-only loss).
"""
...
OUT = "/home/jovyan/work/Nemotron-training/outputs/csv_train_ddp_v10_eqmode_strict"
